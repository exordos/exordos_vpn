...
class OpenVPNManagementClient:
    ...
    def __init__(self, socket_path: Optional[str] = None,
                 host: str = 'localhost', port: int = 7505):
        """
    ...
    def connect(self) -> bool:
        ...
        try:
            ...
            if not self.sock.recv(4096).decode('utf-8', errors='ignore').startswith('>INFO:'):
                self.logger.error("Did not receive expected welcome message,disconnecting!")
                self.disconnect()
                return False
    ...
    def _receive_response(self, timeout: Optional[float] = None) -> str:
        ...
        try:
            ...
            while True:
                ...
                if b"\nEND" in response[-10:] or b"\nSUCCESS: " in response or b"\nERROR: " in response:
                    break
